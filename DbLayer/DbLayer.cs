...
namespace Clover.DbLayer
{
    ...
    {
        internal const int DefaultRecordLimit = 300;
    ...
    internal static class DbManager
    {
        ...
        /// <returns></returns>
        internal static List<T> DbQueryList<T>(DbTransactionHandler handler, string sqlCommand, object parameters = null)
        {
            if (handler == null)
            {
        ...
        /// <param name="parameters">Objecto anónimo con los parámetros del comando.</param>
        /// <returns></returns>
        internal static T DbQuerySingle<T>(DbTransactionHandler handler, string sqlCommand, object parameters)
        {
            if (handler == null)
            {
                using (var dbConnection = new MySqlConnection(DbLayerSettings.ConnectionString))
        ...
        /// <param name="sqlCommand">Comando SQL.</param>
        /// <param name="parameters">Objecto anónimo con los parámetros del comando.</param>
        internal static void DbExecuteNonQuery(DbTransactionHandler handler, string sqlCommand, object parameters)
        {
            if (handler == null)
            {
                using (var dbConnection = new MySqlConnection(DbLayerSettings.ConnectionString))
    ...
    public class CustomerPayment : DbEntity
    {
        ...
        public void Insert(DbTransactionHandler handler = null)
        {
            const string sqlCommand = "INSERT INTO customer_payment (BusinessID, CustomerID, Date, AccountID, TotalAmount, CurrencyID, AdditionalInformation, IsUnmarked)"
                              + " VALUES (@BusinessID, @CustomerID, @Date, @AccountID, @TotalAmount, @CurrencyID, @AdditionalInformation, @IsUnmarked);";
